...
enum DialogOptions {
	static let common: [OptionDefinition] = [
		...
		OptionDefinition(name: "width",      kind: .string, help: "Panel content width (points or N%)"),
		OptionDefinition(name: "height",     kind: .string, help: "Panel content height (points or N%)"),
		...
		OptionDefinition(name: "json",       kind: .boolean, aliases: ["debug"], help: "Emit a JSON object with button, values, exit"),
